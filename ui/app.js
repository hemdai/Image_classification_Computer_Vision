    ...
    dz.on("complete", function (file) {
        ...
        $.post(url, {
            ...
            */
            ...
            let players = ["Lional_messi", "mbappe", "Marion_Cotillard", "paris_hilton"];
            
            let match = null;
            let bestScore = -1;
            for (let i=0;i<data.length;++i) {
                let maxScoreForThisClass = Math.max(...data[i].class_probablity);
            ...
            if (match) {
                ...
                for(let personName in classDictionary) {
                    ...
                    let proabilityScore = match.class_probablity[index];
